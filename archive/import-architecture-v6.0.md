...
**Page:** `src/pages/import/ImportPage.tsx` (INTEGRATED WITH DATASET CREATION)  
**Purpose:** Upload file, parse columns, AI mapping, create ACTIVE products  
...
**Integrated in ImportPage (v7.0):**
- ✅ File upload interface
- ✅ File format validation
- ✅ Progress indicator during parsing
- ✅ **Supplier/Brand selection** (part of dataset creation)
- ✅ **AI Column Mapping** (integrated wizard)
- ✅ **Validation preview** (before dataset creation)
- ✅ **Dataset creation** (creates ACTIVE products + deactivates old)
- ✅ **Success toast** with activated + deactivated counts
...
2. Clicks "Nieuw Bestand Uploaden"
...
9. Products immediately visible in `/supplier-catalog`
